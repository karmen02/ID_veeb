...
//loome objekti mis ongi express.js program ja edasi kasutamegi seda
const app = express(); //app on nagu server
const fs = require("fs");
...
// päringu URL-i parsimine, eraldame POST osa. False kui ainult tekst, true kui muu info ka.
...
app.get("/vanasonad", (req,res)=>{
	fs.readFile("public/txt/vanasonad.txt", "utf8", (err, data)=>{
		if(err){
			res.render("genericlist",{heading: "Vanasõnad", listData:["Kahuks vanasõnasid ei leidnud!"]}); 
		} else {
